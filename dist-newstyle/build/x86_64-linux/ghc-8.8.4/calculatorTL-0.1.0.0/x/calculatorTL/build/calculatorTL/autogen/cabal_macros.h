...
/* package calculatorTL-0.1.0.0 */
#ifndef VERSION_calculatorTL
#define VERSION_calculatorTL "0.1.0.0"
#endif /* VERSION_calculatorTL */
#ifndef MIN_VERSION_calculatorTL
#define MIN_VERSION_calculatorTL(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_calculatorTL */
...
#define CURRENT_COMPONENT_ID "calculatorTL-0.1.0.0-inplace-calculatorTL"
